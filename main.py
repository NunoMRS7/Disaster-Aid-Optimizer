...
def main():
    # Create vehicle instance with autonomy and capacity
    drone = Vehicle(VehicleType.DRONE, autonomy=500.0, capacity=10.0)
    
    random_graph = None  # Initialize the graph as None
